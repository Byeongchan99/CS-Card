...
related: ["Dictionary가-평균-O1-조회를-달성하는-내부-원리", "같은-bucket으로-간-키들을-Dictionary는-메모리에-어떤-구조로-저장하는가", "Dictionary에서-중간-항목을-Remove하면-entries-배열의-구멍을-어떻게-처리하는가", "List-Clear의-내부-동작", "List의-Add가-상환-O(1)인-이유"]
