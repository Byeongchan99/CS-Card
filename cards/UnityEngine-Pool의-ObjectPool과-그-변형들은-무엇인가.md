...
tags: [유니티, 성능, 메모리]
related: ["오브젝트-풀링은-무엇이고-어떻게-GC-부담을-줄이는가", "풀에서-꺼낸-오브젝트의-상태-리셋은-어떻게-하는가", "Instantiate와-Destroy는-각각-왜-비싼-연산인가", "유니티-GC의-내부-동작", "오버로딩된-null-체크가-성능-함정이-되는-이유와-완화법"]
parent: "오브젝트-풀링은-무엇이고-어떻게-GC-부담을-줄이는가"
date: 2026-07-23
result: 틀림
status: 완성
---
