...
related: ["옵저버-패턴에서-새-반응자-추가가-쉬운-이유-OCP-DIP", "옵저버-패턴은-무엇과-무엇을-분리하는가", "Notify-순회-도중-옵저버가-자기-자신을-구독-해제하면", "Csharp-event로-옵저버를-구현하면-세-문제가-어떻게-되는가", "enum과-switch-기반-FSM을-상태-패턴으로-바꿀-때-얻는-것과-잃는-것"]
